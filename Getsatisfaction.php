...
require_once 'Eden/getsatisfaction/Error.php';
require_once 'Eden/getsatisfaction/Base.php';
require_once 'Eden/getsatisfaction/Company.php';
require_once 'Eden/getsatisfaction/Detail.php';
require_once 'Eden/getsatisfaction/Oauth.php';
require_once 'Eden/getsatisfaction/People.php';
require_once 'Eden/getsatisfaction/Product.php';
require_once 'Eden/getsatisfaction/Reply.php';
require_once 'Eden/getsatisfaction/Replies.php';
require_once 'Eden/getsatisfaction/Tag.php';
require_once 'Eden/getsatisfaction/Topic.php';
