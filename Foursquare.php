...
require_once 'Eden/Foursquare/Error.php';
require_once 'Eden/Foursquare/Base.php';
require_once 'Eden/Foursquare/Oauth.php';
require_once 'Eden/Foursquare/Campaign.php';
require_once 'Eden/Foursquare/Checkins.php';
require_once 'Eden/Foursquare/Events.php';
require_once 'Eden/Foursquare/List.php';
require_once 'Eden/Foursquare/Pages.php';
require_once 'Eden/Foursquare/Pageupdates.php';
require_once 'Eden/Foursquare/Photos.php';
require_once 'Eden/Foursquare/Settings.php';
require_once 'Eden/Foursquare/Specials.php';
require_once 'Eden/Foursquare/Tips.php';
require_once 'Eden/Foursquare/Updates.php';
require_once 'Eden/Foursquare/Users.php';
require_once 'Eden/Foursquare/Venue.php';
require_once 'Eden/Foursquare/Venuegroups.php';
