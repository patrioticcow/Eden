...
require_once 'Eden/Xend/Base.php';
require_once 'Eden/Xend/Error.php';
require_once 'Eden/Xend/Booking.php';
require_once 'Eden/Xend/Rate.php';
require_once 'Eden/Xend/Shipment.php';
require_once 'Eden/Xend/Tracking.php';
