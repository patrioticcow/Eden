...
require_once 'Eden/Cql/Database.php';
require_once 'Eden/Cqlite/Error.php';
require_once 'Eden/Cqlite/Alter.php';
require_once 'Eden/Cqlite/Create.php';
require_once 'Eden/Cqlite/Utility.php';
